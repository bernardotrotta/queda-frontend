...
export default function PaginaUtente() {
    ...
    return (
        <div className="min-h-screen bg-slate-200 flex flex-col items-center">
            ...
            <main className="relative grow w-full flex flex-col items-center justify-center">

                {/* Effetto fade in alto e in basso */}
                <div className="absolute top-0 w-full h-[25%] bg-linear-to-b from-slate-200 to-transparent z-10 pointer-events-none" />
                <div className="absolute bottom-0 w-full h-[25%] bg-linear-to-t from-slate-200 to-transparent z-10 pointer-events-none" />

                {/* Lista Scorrevole */}
                <div ref={scrollContainerRef} className="w-full h-[80vh] overflow-y-scroll snap-y snap-mandatory no-scrollbar py-[25vh]">
